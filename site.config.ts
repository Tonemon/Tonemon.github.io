...
const siteConfig: SiteConfig = {
  ...
  bio: 'A cyber security student and researcher interested in offensive security and open source software. I document my CTF writeups, security research, homelab experiments, network architectures, and hobby projects here.',
  focusBadges: [
